  ...
  return (
    ...
    <div className=" relative flex w-80 lg:w-100 h-90 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
      ...
      <div className="mb-5  mt-10 flex justify-center items-center">
        ...
        <StyledWrapper>
          <button data-ripple-light="true" type="button" className="select-none rounded-lg bg-transparent py-1 px-1 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
            Read More
          </button>
        </StyledWrapper>
        </Link>
